...
function CompetitionCard({
  ...
  return (
    <section className="mini-card competition-card">
        ...
        {competitions.map((competition) => (
          ...
          >
            ...
            <div className="competition-date-wrap">
              ...
              <span className="label event-label">
                Event Date
              </span>

              <span className="competition-date-val">
                {competition.date}
              </span>
      ...
      <button
        type="button"
        className="competition-footer-link"
        onClick={onOpen}
      >
        View Details <b>→</b>
      </button>
...
export default function Dashboard() {
  ...
  const [newCompetition, setNewCompetition] =
    useState("");

  const [competitionDate, setCompetitionDate] =
    useState("");

  const [competitionFormOpen, setCompetitionFormOpen] =
    useState(false);
        ...
        <section className="tasks-card">
          ...
          <div className="task-table">
            ...
            <div className="task-row task-head">
              ...
              <span className="task-action-head" />
