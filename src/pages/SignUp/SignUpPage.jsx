...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      console.error(
        "Firebase Detailed Sign Up Error:",
        err
      );
  ...
  return (
    <div className="signup-container">
      ...
      <div className="hud-overlay hud-left">
        ...
        <div>
          <span className="hud-label">STATUS</span> : REGISTRATION
        </div>
      ...
      <div className="hud-overlay hud-right">
        <div>
          <span className="hud-label">MODE</span> : NEW USER
        </div>

        <div>
          <span className="hud-label">ENCRYPTION</span> : AES-256
        </div>
      </div>
